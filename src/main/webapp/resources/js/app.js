    ...
    class FormSteps {
        ...
        updateForm() {
            ...
            let webSideForm = [
                ...
                {valueId: 'pickUpTime', summaryId: 'pickUpTimeDonation'},
                {valueId: 'comment', summaryId: 'commentDonation'}
            ];

            webSideForm.forEach((element) => {
                let value = document.getElementById(element.valueId).value;
                document.getElementById(element.summaryId).innerText = value;
            });
